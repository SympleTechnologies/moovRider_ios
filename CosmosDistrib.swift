...
class CosmosLayerHelper {
    ...
    class func createTextLayer(_ text: String, font: UIFont, color: UIColor) -> CATextLayer {
        // let size = NSString(string: text).size(attributes: [NSAttributedString.zone: font])
        let size = NSString(string: text).size(withAttributes: [NSAttributedStringKey.font: UIFont.systemFont(ofSize: 14.0)])
